...
//    }
    ...
    public void init(){
//        Pokemon[] pokedex1, Pokemon[] pokedex2, Pokemon[] pokedex3, Pokemon[] pokedex4, Pokemon[] pokedex5, Pokemon[] pokedex6, Pokemon[] pokedex7
        ...
        tbrow0.addView(tv3);
        stk.addView(tbrow0);
//        Pokemon[] pokedex1 = Example.getDex(1);
        for(int n=0; n <=150; n++) {
